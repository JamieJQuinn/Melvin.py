...
class SpectralTransformer:
    ...
    def __to_physical_2d(
        ...
        if (
            basis_functions[0] is BasisFunctions.COSINE
            or basis_functions[0] is BasisFunctions.SINE
        ):
